jQuery(document).ready(function($) {
    ...
    jQuery(".login,.login-links-r a").click(function() {
        jQuery(".panel-pop").animate({ "top": "-100%" }, 10).hide();
        jQuery("#login").show().animate({ "top": "50%" }, 500);
        jQuery("body").prepend("<div class='wrap-pop'></div>");
        wrap_pop();
        return false;
    });
    // jQuery(".signin,.login-links-r a").click(function() {
    //     jQuery(".panel-pop").animate({ "top": "-100%" }, 10).hide();
    //     jQuery("#signin").show().animate({ "top": "50%" }, 500);
    //     jQuery("body").prepend("<div class='wrap-pop'></div>");
    //     wrap_pop();
    //     return false;
    // });
